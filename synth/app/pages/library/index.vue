<template>
  <div class="mt-3 border mx-auto w-[85rem] min-h-[85vh] p-6">
    <div class="mb-6">
      ...
      <p class="text-muted-foreground">Explore and comment on audios from the community</p>
    </div>
    ...
    <div v-else-if="audioStore.audios.length === 0" class="text-center py-8">
      <p class="text-muted-foreground">No audios yet. Start by creating one in the studio!</p>
    </div>
